...
(function($, window, Math) {
    ...
    Lightbox.DEFAULTS = {
        modalTeamplate: '<div class="icon-spinner icon-spin loader"></div><div class="modal-dialog"><button class="close" data-dismiss="modal" aria-hidden="true"><i class="icon-remove"></i></button><button class="controllers prev"><i class="icon icon-chevron-left"></i></button><button class="controllers next"><i class="icon icon-chevron-right"></i></button><img class="lightbox-img" src="{image}" alt="" data-dismiss="modal" /><div class="caption"><div class="content">{caption}<div></div></div>'
    }; // default options
    ...
    Lightbox.prototype.bindEvents = function() {
        ...
        $e.modalTrigger({
            ...
            custom: function(e) {
                ...
                modal.find('.controllers').click(function() {
                    var $this = $(this);
